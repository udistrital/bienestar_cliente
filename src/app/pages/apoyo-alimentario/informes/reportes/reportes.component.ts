...
export class ReportesComponent implements OnInit {
  ...
  constructor(private autenticacion: ImplicitAutenticationService) {
    ...
    this.reportes = [
      { name: 'Estudiantes por Estratos', label: 'apale' },
      { name: 'Estudiantes por Facultad', label: 'apalf' },
      { name: 'Estudiantes por Proyectos curriculares', label: 'apalpc' },
      { name: 'Estudiantes por Localidades', label: 'apall' },
      { name: 'Cuantos estudiantes  tienen hijos', label: 'apalh' },
      { name: 'Estudiantes que presente alguna condicion de violencia o poblacion especial', label: 'apalce' },
      { name: 'Número de almuerzos diarios entregados', label: 'apalsd' },
      { name: 'Número de almuerzos semanales entregados ', label: 'apalss' },
      { name: 'Número de almuerzos mensuales entregados ', label: 'apalsm' },
      { name: 'Número de almuerzos entregados en un periodo ', label: 'apalsp' },
    ];
    /* 
    { name: 'Apropiación inicial', label: 'apropiacion_inicial' },
      { name: 'Consecutivo compromisos', label: 'cons_compr' },
